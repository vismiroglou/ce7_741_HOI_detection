...
if __name__ == '__main__':
    ...
    labels_741 = ['human-hold-bicycle', 'human-ride-bicycle', 'human-ride-motorcycle', 'human-walk-bicycle', 'human-walk-motorcycle', 'human-hold-motorcycle']
    ...
    save_to_path = r"../data_anno/training_data_coords.csv"
    ...
    anno_path = r'../data_anno/testing_data.csv'
    img_path = r'../../dataset/images'
    save_to_path = r"../data_anno/testing_data_coords.csv"
